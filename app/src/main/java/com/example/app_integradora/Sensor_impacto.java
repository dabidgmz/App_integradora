...
public class Sensor_impacto extends AppCompatActivity {
    ...
    CardView alertaCardView;
    TextView alertaTextView;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.menuPorfile) {
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, profile.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);

                    return true;
                } else if (item.getItemId()==R.id.menuAgregarEmpresa) {
                    Intent intent = new Intent(Sensor_impacto.this, agregar_empresa1.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, agregar_vitrina1.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, agregar_sensor1.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, Sensor_mov.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, sensor_gas.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, sensor_luz.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, Sensor_humedad.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, Sensor_temperatura.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    Intent intent = new Intent(Sensor_impacto.this, Sensor_impacto.class);
                    startActivity(intent);
                    drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    for (Modelprincipal.FeedData feedData : model.getData()) {
                        ...
                        switch (feedKey) {
                            case "impacto":
                                ...
                                TextView alertaTextView = alertaCardView.findViewById(R.id.alerta_text_view);

                                if ("1".equals(value)) {
                                    // Display "Hay impacto" message
                                    alertaTextView.setText("Hay impacto");
                                } else if ("0".equals(value)) {
                                    // Display "No hay impacto" message
                                    alertaTextView.setText("No hay impacto");
                                }                                break;
                            default:
                                break;
                        }
